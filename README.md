...
Skrypt eksportu zapisze też etykiety modelu do `assets/labels_yolo11.json`, dzięki czemu
aplikacja wyświetli nazwy klas (np. rasy kotów) zgodnie z checkpointem.
